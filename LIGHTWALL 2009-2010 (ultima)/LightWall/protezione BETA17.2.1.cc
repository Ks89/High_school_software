...
//Modifica marginale infatti 17.2.1 e non 17.3.0 perchè aggiungo solo md5 e sha sull'intero file di licenze
...
//NOVITA':
//-Aggiunti md5 e sha sui file di licenza con correzione dei bug a loro associati
//-corretto bug di lettura e salvataggio md5 che tramite reg manuale, dopo attivazione, rendeva programma inutilizzabile
...
printf("             *****************************************************\n");
printf("             *..::Benvenuto in LIGHTWALL BETA 17.2.1 by ks89!::..*\n");
printf("             *****************************************************\n\n");
