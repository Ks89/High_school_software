...
//VERSIONE BETA 2.1.0 di LCL compatibile solo da versione protezione lightwall beta 17.3.2 e NON SUPPORTA PIU' RIPRSITNO FABBRICA che è stato rimosso e sostiuito del tutto da LCL 2.0.0
//Questa versione comprende per la primissima volta la generazione risposta beta 5. Infatti da questa versione generaz risposta scompare del tutto e viene sostituito da questo
...
//-Aggiunta comando VIEWF che mostra solo le cose sui file e VIEW che mostra le strutture
//-Aggiunta generazione risposta con la struttura generate.1.1 che avvia la generazione risposta con una procedura guidata
...
printf("         *************************************************************\n");
printf("         *..::Benvenuto in LIGHT COMMAND LINE BETA 2.1.0 by ks89!::..*\n");
printf("         *************************************************************\n\n");
