...
//  usando il trucchetto di h=-13!!! Perchè di colpo matrix2 si carica con dei dati sbagliati e non so il perchè!!!!
//  ci devo ancora lavorare. ma lo lascio per la 15.7.4 che sarà una cosa un po' impegnativa e non riskio di danneggiare questo codice che funziona
//2)ce ne è uno che si presenta a caso sullo sblocco licenza. Cioè ogni tanto me la lascia sbloccare
//  Non ho capito ne quando si verifica, ne perchè ne molte altre cose. Insomma BOOO!!! Succede molto raramente! Ma può capitare
...
//quindi non toccarla perchè non ho la minima idea di come risolvere i problemi legati a questo piccolo frammento
...
//rileggo il file per sicurezza, in verità non servirebbe perchè lo ho già letto prima dell'if firstexec, ma non si sa mai
...
printf("\n %d%d%d%d%d \n",activate.codice_dat[0],activate.codice_dat[1],activate.codice_dat[2],activate.codice_dat[3],activate.codice_dat[4]);
...
int acontrollo_dat=7-(((activate.codice_dat[0]*6)+(activate.codice_dat[1]*5)+(activate.codice_dat[2]*4)+(activate.codice_dat[3]*3)+(activate.codice_dat[4]*2))%7);
printf("\n %d %d \n",acontrollo_dat,activate.controllo_dat);
printf("\n acticate.codice_dat%d%d%d%d%d%d%d \n",activate.codice_dat[0],activate.codice_dat[1],activate.codice_dat[2],activate.codice_dat[3],activate.codice_dat[4],activate.codice_dat[5],activate.codice_dat[6]);

...
/*IMPO!!*/ if ((write.inutile==12344) && (write.inutile2==-546.451405) && (strcmp(write.reg,c2)==0)) {
      ...
      if ((cfPtr=fopen("ks.dat","rb"))==NULL) printf("Errore x035\n");    //leggo file
		   ...
		   printf("\n write.codice=%d%d%d%d%d cont:%d \n",write.codice[0],write.codice[1],write.codice[2],write.codice[3],write.codice[4],write.controllo);
           if (write.controllo==7-(((write.codice[0]*6)+(write.codice[1]*5)+(write.codice[2]*4)+(write.codice[3]*3)+(write.codice[4]*2))%7)) isbn=1;                           //è 1 se il codice di controllo è ok. 
...
/*_*/       if ((testdamage_file!=activatecontrollodat) && (writecontrollo==isbn) && (controllo_mixer==1))
            {  //vuol dire che lic,dat è danneggiato ma non ks.dat
