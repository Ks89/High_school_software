...
//necessario per isolvere bug licenza che da errore x036 dopo 3 tentativi di attivazione
...
if ((strcmp(writepc.nomepc_w,nome_pc)==0) && (strcmp(pathW.path_pathW,directory)==0) && (controllo_nomepc==1) && (controllo_percorso==1) && (write.inutile==12344) &&
	(write.inutile2==-546.451405) && (isbn2==1) && (activate.inutile_a==12344) && (activate.inutile2_a==-546.451405) && (h==100))
