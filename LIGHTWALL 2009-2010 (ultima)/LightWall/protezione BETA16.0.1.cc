...
//BETA 16.0.1 SOURCECODE, sembra funzionare davvero!!!!!! Inoltre va bene sia su WINDOWS 7 x86 che x64!!! OTTIMO DAVVERO!
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
//Versione che corregge solo 2 bug minori che non influenzano il programma se non in casi davvero rarissimi
//NOVITA':
//-Corretto errore dei for che fanno solo 15 giri per salvare nome pc, qunado invece la lunghezza massima nella struttura è di 20. BUG CORRETTO anche in rispristino fabbrica
//-Corretto errore dei for che fanno solo 15 giri in un punto del programma dovuto al copia incolla da nomepc, senza fare attenzione,
   //quando invece la lunghezza massima nella struttura è di 100.



//2 Bug irrisolti per ora
//--il codice risposta sblocco ogni tanto da come numero anche un 10. Errore, devono essere sempre <=9
//--Problema sulla gestione del percorso con LCL. Da soli entrambi i programmi funzionano. Insieme però no, percheè il percorso scritto da LCL sui file non viene letto correttamente da LightWall
...
printf("             *****************************************************\n");
printf("             *..::Benvenuto in LIGHTWALL BETA 16.0.1 by ks89!::..*\n");
printf("             *****************************************************\n\n");
