...
//BETA 17.0.0 SOURCECODE, funziona davvero!!!!!! Inoltre va bene sia su WINDOWS 7 x86 che x64!!! OTTIMO DAVVERO!
#include <stdlib.h>
#include <time.h>
#include <conio.h>
#include <iostream>
...
//NON sopporta più la retrocompatibilità con ripristino fabbrica beta 8 e con versioni di LCL precedenti a beta 2.0.0
//Richiede obbligatoriamente LCL beta 2.0.0
...
//-Possibilità di convertire una licenza Home in professonal
...
printf("             *****************************************************\n");
printf("             *..::Benvenuto in LIGHTWALL BETA 17.0.0 by ks89!::..*\n");
printf("             *****************************************************\n\n");
...
if (strcmp(write.reg,c1)==0){//apre un if che finisce sotto, dopo un bel pezzo di programma
  ...
  { //se tutti veri significa che la risposta è corretta
		     ...
		     /*IMPO!!*/  printf("\n\nCodice corretto\n");    // qui teoricamente ,ci dovrebbe essere tutto il programma al quale vorrei applicare il sistema di protezione
						 ...
						 scanf("%d",&tipol);
						 now(gio,mese,anno,gios,ora,min,sec); //leggo data
						 license.anno_s=anno+tipol; //imposto scadenza. Se 0 vuol dire che è illiminata, se 1,2,3 indica il numero di anni di validità
