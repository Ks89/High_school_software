...
//VERSIONE BETA 1.0.0 di LCL compatibile solo da versione protezione lightwall beta 16 e ripristino fabbrica beta8. 

//ATTENZIONE QUESTA VERSIONE E' PRIMITIVA. REALIZZATA SOLO PER TESTARE LE SUE FUNZIONALITA'
//PUO' PRESENTARE ANCORA MOLTI PROBLEMI, IN QUANTO NON TESTATA A FONDO, COME SI DOVREBBE FARE

//ATTENZIONE, LA GENERAZIONE DELLA MATRICE NON E' ANCORA PRESENTE, QUINDI NON E' POSSIBILE REGISTRARE O CAMBIARE LA LICENZA A LIGHTWALL, CAMBIANO IL CODICE UTENTE, PER ESEMPIO
//Per farlo attendere versioni successive, più sicure e testate.
...
//*****************************************************inizio dichiarazione varibili***************************************************************
   ...
   int punto1=0,punto2=0,test=0,i=0,y=0,lunghezza=0,z=0,lun=0;
...
printf("         *************************************************************\n");
printf("         *..::Benvenuto in LIGHT COMMAND LINE BETA 1.0.0 by ks89!::..*\n");
printf("         *************************************************************\n\n");
...
//**********************************************************************************************************************************************************
  ...
  if(strcmp(struttura,"writepc")==0)
  {
	  ...
	  if(strcmp(comando,"matrice")==0) {
										 //è impensabile creare la matrice a mano allora la inzializzo tutta a 0 così sono a posto
										printf("\n***Comando eseguito***\n");
  ...
  if(strcmp(struttura,"pathw")==0)
  {
	  ...
	  if(strcmp(comando,"matrice")==0) {
										 //è impensabile creare la matrice a mano allora la inzializzo tutta a 0 così sono a posto
										 printf("\n***Comando eseguito***\n");
										 for(z=0;z<10;z++) for(y=0;y<10;y++) pathW.matrice_pathW[z][y]=0;
	                                   }
  }
  ...
  if(strcmp(struttura,"write")==0)
  {
	  ...
	  if(strcmp(comando,"matrice")==0) {
										 printf("\n***Comando eseguito***\n");
										 //è impensabile creare la matrice a mano allora la inzializzo tutta a 0 così sono a posto
										 for(z=0;z<10;z++) for(y=0;y<10;y++) write.matrice[z][y]=0;
	                                   }
  ...
  if(strcmp(struttura,"lic")==0)
  {
	  ...
	  if(strcmp(comando,"codice_licenza")==0) { 
...
if(strcmp(struttura,"view")==0)
  { 
	  ...
	  {
		 printf("\n***Comando eseguito***\n");
		 if ((cfPtr=fopen("irr.dat","rb"))==NULL) printf("Errore x014\n");
		 else {
		 ...
		 if ((cfPtr=fopen("license.lic","rb"))==NULL) printf("Errore x014\n");
		 else {
	     ...
	     if ((cfPtr=fopen("rek.dll","rb"))==NULL) printf("Errore x014\n");
		 else {
...
if(strcmp(struttura,"restore")==0)
{
	if(strcmp(comando,"ks")==0)
	{
		...
		printf("\n***Comando eseguito***\n");
		if ((cfPtr=fopen("ks.dat","rb+"))==NULL) printf("Errore Lx001\n");  //apro file in scrittura
		else {
	...
	{ 	
		//resetto il file rek.dll
		printf("\n***Comando eseguito***\n");
		if ((cfPtr=fopen("lic.dat","rb+"))==NULL) printf("File lic.dat non trovato\n");  //apro file in scrittura
		else {
...
if(strcmp(struttura,"save")==0)
  { 
	  if(strcmp(comando,"ks")==0){
									printf("\n***Comando eseguito***\n");
									if ((cfPtr=fopen("ks.dat","rb+"))==NULL) printf("Errore x001");  //apro file
									else {
			                        		fseek(cfPtr,0,SEEK_SET); 
			                        		fwrite(&write,sizeof(struct writeData),1,cfPtr); //scrivo sul file i valori impostati prima come record
			                        		fclose(cfPtr);                   //chiudo file
	  ...
	  if(strcmp(comando,"rek")==0){
									printf("\n***Comando eseguito***\n");
									if ((cfPtr=fopen("rek.dll","rb+"))==NULL) printf("Errore x002");  //apro file
									else {
			                        		fseek(cfPtr,0,SEEK_SET); 
			                        		fwrite(&writepc,sizeof(struct writepcData),1,cfPtr); //scrivo sul file i valori impostati prima come record
			                        		fclose(cfPtr);                   //chiudo file
	  ...
	  if(strcmp(comando,"lic")==0){
									printf("\n***Comando eseguito***\n");
									if ((cfPtr=fopen("lic.dat","rb+"))==NULL) printf("Errore x003");  //apro file
									else {
			                        		fseek(cfPtr,0,SEEK_SET); 
			                        		fwrite(&activate,sizeof(struct activate_licData),1,cfPtr); //scrivo sul file i valori impostati prima come record
			                        		fclose(cfPtr);                   //chiudo file
	  ...
	  if(strcmp(comando,"license")==0){
									printf("\n***Comando eseguito***\n");
									if ((cfPtr=fopen("license.lic","rb+"))==NULL) printf("Errore x004");  //apro file
									else {
			                        		fseek(cfPtr,0,SEEK_SET); 
	  ...
	  if(strcmp(comando,"irr")==0){
									printf("\n***Comando eseguito***\n");
									if ((cfPtr=fopen("irr.dat","rb+"))==NULL) printf("Errore x005");  //apro file
									else {
			                        		fseek(cfPtr,0,SEEK_SET); 
