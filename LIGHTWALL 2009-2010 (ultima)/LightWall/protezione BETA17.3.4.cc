...
//NOVITA':
//-aggiunta stringa da 1000 numeri generati a caso sul file licenza eccetto 10 con la struttura doorexit (difficile da spiegare, vedere algoritmo), alla fine, per complicare la struttura
//-Sostituiti tutti i rand()%9 con rand()%10, perchè il primo da solo da 0 a 8, mentre quello dopo da anche il 9
//-Sostituiti activate.codice_a2=rand() % 8 + 1; e activate.codice_a4=rand() % 8 + 1; con i 2 rand() % 9. 
...
printf("             *****************************************************\n");
printf("             *..::Benvenuto in LIGHTWALL BETA 17.3.4 by ks89!::..*\n");
printf("             *****************************************************\n\n");
